...
public class MobOTPValidonlyAPI {

    private static final String TAG = " OTPSubmitAPI ";

    public static void submitOtp(final Context context, final String app_id, final String token, final String user_id, final MobOTPValidOnlyCallback callBackResponse ) {
        ...
        JsonObjectRequest getReq = new JsonObjectRequest(Request.Method.POST, url, jsonObject,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        callBackResponse.getMobOTPVerify(otpResponseModel);
