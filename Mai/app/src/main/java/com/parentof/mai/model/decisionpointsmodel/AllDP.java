...
public class AllDP implements Parcelable {
    ...
    public static final Creator<AllDP> CREATOR = new Creator<AllDP>() {
        @Override
        public AllDP createFromParcel(Parcel in) {
            return new AllDP(in);
        }

        @Override
        public AllDP[] newArray(int size) {
            return new AllDP[size];
        }
    };
